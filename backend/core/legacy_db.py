...
MODEL_MAP = {
    ...
    'item_uom_profiles': ItemUOMProfile,
    'item_sku_templates': ItemSKUTemplate,
    'item_variants': ItemVariant,
    'price_lists': PriceList,
    'price_list_items': PriceListItem,
    # ── Phase 1: Manufacturing Physics ───────────────────────────────────────
    'bom_headers': BillOfMaterials,
    'bom_items': BOMItem,
    'adhesive_mix_formulas': AdhesiveMixFormula,
    'coating_orders': CoatingOrder,
    'jumbo_rolls': JumboRoll,
    'slitting_orders': SlittingOrder,
    'production_shift_logs': ProductionShiftLog,
    'scrap_entries': ScrapEntry,
    # ── Phase 1: HRMS Extended + Assets ──────────────────────────────────────
    'leave_balances': LeaveBalance,
    'leave_applications': LeaveApplication,
    'shift_masters': ShiftMaster,
    'employee_shift_rosters': EmployeeShiftRoster,
    'attendance_records': AttendanceRecord,
    'employee_salary_assignments': EmployeeSalaryAssignment,
    'payroll_runs': PayrollRun,
    'payslip_entries': PayslipEntry,
    'employee_loans_ext': EmployeeLoan,
    ...
    'purchase_enquiries': PurchaseEnquiry,
    'vendor_quotations': VendorQuotation,
    'goods_received_notes': GoodsReceivedNote,
    'purchase_invoices': PurchaseInvoice,
    'landed_cost_vouchers': LandedCostVoucher,
    # ── Phase 1: AI Agent Layer ───────────────────────────────────────────────
    'ai_agents': AIAgent,
    'agent_run_logs': AgentRunLog,
    'task_escalations': TaskEscalation,
    'buying_dna_profiles': BuyingDNAProfile,
